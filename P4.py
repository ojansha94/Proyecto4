...
# ---
# 
# * Estudiante: **Brayan Mauricio Vega Ortega**
# * Carné: **B47519**
# * Grupo: **1/2**
# 
# ---
...
# Para esta sección se implementan las funciones definidas en las secciones anteriores
...
# Se definen los distintos parámetros a emplear
fc = 5000  # frecuencia de la portadora
mpp = 20   # muestras por periodo de la portadora
...
senal1, Pm1, portadora1, moduladora1 = modulador(bits_Tx, fc, mpp,1)
senal2, Pm2, portadora2, moduladora2 = modulador(bits_Tx, fc, mpp,0)

Pm = Pm1 + Pm2
senal_Tx = senal1 + senal2
...
# Función de la transformada de Fourier
...
f = np.linspace(0.0,1.0/(2.0*T_m),Nm//2) 
